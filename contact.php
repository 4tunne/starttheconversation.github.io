...
<title>Contact Us: Learning</title>
<meta charset="utf-8">
...
<body>
	...
	<section class="ftco-section">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light"> <a class="navbar-brand" href="index.html"><img src="assets/images/stc-logo.png" width="80"></a>
			  
			  <a class="navbar-brand" href="index.html"><img src="assets/images/New icons/home button.png" width="80"></a>
		  </nav>
<div class="row justify-content-center">
	  <div class="col-md-6 text-center mb-5">
					<h2 class="heading-section" style="font-size: 45px;">Contact <span style="color: #f15a24;">Us</span></h2>
					<hr>
					<p style="font-size: 15px;">If you have questions or just want to get in touch, use the form below. We look forward to
						hearing from you!</p>
				</div>
			</div>
			<div class="row justify-content-center">
					...
					<div class="wrapper">
						<div class="row no-gutters mb-5">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="message" id="subject"
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea name="message" class="form-control" id="message" cols="30"
														rows="4" placeholder="Enquiry/Message"></textarea>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
							...
							<div class="col-md-5 d-flex align-items-stretch">
								<div id="map">
									<iframe
										src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5215.330157210196!2d28.044194204785384!3d-26.105088531584524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1e957336b2d1d885%3A0xcee134a93997b582!2sStart%20the%20Conversation!5e0!3m2!1sen!2sza!4v1685796069308!5m2!1sen!2sza"
		...
		<div class="col-md-4 mb-md-0 mb-4 d-flex">
		  <div class="con con-1 w-100 py-5">
			<div class="con-info w-100 text-center">
			  ...
			  <div class="text">
				<span><a href="tel:011 283 0859">011 283 0859</a></span>
			  </div>
			</div>
		  </div>
		</div>
		  ...
		  <div class="row">
			<div class="col-md-4 mb-md-0 mb-4">
			  ...
			  <ul class="list-unstyled">
				...
				<li><a href="#" class="d-block">News</a></li>
